...
UCLASS(Blueprintable, ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))class KSHUNREALCPP_API UResourceComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	inline float GetCurrentStamina() { return CurrentStamina; }
